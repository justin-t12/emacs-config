...
;; have evil mode respect visual lines (needs to be here to set before evil is
;; loaded)
...
(doom! :input
       ...
       ;;(latex +cdlatex +lsp +fold +latexmk) ; writing papers in Emacs has never been so fun
       ...
       (org +pandoc +dragndrop +noter +gnuplot) ; organize your plain life in plain text
